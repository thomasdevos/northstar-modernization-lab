"""Replacement slice. One rounding mismatch is deliberately retained for the lab."""
...
def _money(value: Decimal) -> str:
    return str(value.quantize(PENNY, rounding=ROUND_HALF_EVEN))
...
def settle(row: dict[str, str]) -> dict[str, str]:
    ...
    # KNOWN LAB GAP: bankers' rounding differs from legacy ROUND_HALF_UP at ties.
    fee = max(Decimal("0.35"), amount * Decimal("0.0015")).quantize(PENNY, rounding=ROUND_HALF_EVEN)
    return {
